...
public class Hangman {
    ...
    JPanel bubbleGamePg = new JPanel();
...
//        scoreTitle.setBounds(200, -10, 500, 100);
        ...
        //purpleButton.setBorder(new RoundedBorder(10));
        ...
        //Bubble Game page
        bubbleGamePg.setLayout(null);
        bubbleGamePg.add(bubbleGameTitle);
        bubbleGamePg.add(bubbleText);
        bubbleGamePg.add(redButton);
        bubbleGamePg.add(yellowButton);
        bubbleGamePg.add(blueButton);
        bubbleGamePg.add(greenButton);
        bubbleGamePg.add(purpleButton);
        //bubbleGamePg.add(currentScore);
        ...
        pages.add(bubbleGamePg, "bubbleGamePg");
